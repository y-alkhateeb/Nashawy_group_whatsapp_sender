package ga.nashawygroup.whatsappsender.sender;
...
import ga.nashawygroup.whatsappsender.sender.exception.WhatsappNotInstalledException;
import ga.nashawygroup.whatsappsender.sender.liseteners.GetContactsListener;
import ga.nashawygroup.whatsappsender.sender.liseteners.SendMessageListener;
import ga.nashawygroup.whatsappsender.sender.model.WContact;
import ga.nashawygroup.whatsappsender.sender.model.WMessage;
import ga.nashawygroup.whatsappsender.whatsapp.MediaData;

public class WhatsappApi {
    Context launchContext = null;
    private static WhatsappApi instance;
    private static final String imgFolder = Environment.getExternalStorageDirectory().getAbsolutePath() + "/WhatsApp/Media/WhatsApp Images/Sent";
    private static final String vidFolder = Environment.getExternalStorageDirectory().getAbsolutePath() + "/WhatsApp/Media/WhatsApp Video/Sent";
    private static final String audFolder = Environment.getExternalStorageDirectory().getAbsolutePath() + "/WhatsApp/Media/WhatsApp Audio/Sent";
