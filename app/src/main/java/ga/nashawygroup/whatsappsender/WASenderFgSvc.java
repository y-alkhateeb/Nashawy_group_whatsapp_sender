...
public class WASenderFgSvc extends Service {
        ...
        if (start) {
            ...
            if (rooted) {
                ...
                for (String[] recepient : recipientList) {
                    ...
                    wMessageList.add(new WMessage(Sender.messageToSend/*recepient[1]*/, new File(Sender.uriSelectedImagePath.getPath()), this));
                }
                try {
    ...
    private void send() {
        ...
        String message = Sender.messageToSend;// recipientList.get(progress)[1]; => if there is message in csv file
...
//        sendIntent.setType("image/*");
        ...
        sendIntent.putExtra(Intent.EXTRA_STREAM,Sender.uriSelectedImagePath);
    ...
    private void startMyOwnForeground(){
        String NOTIFICATION_CHANNEL_ID = "ga.nashawygroup.whatsappsender";
